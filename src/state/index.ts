...
const useAppState = () => {
  ...
  const loadWelcomeConversation = () => {
    ...
    setTimeout(
      () =>
        addReceivedMessage(
          welcome,
          "Did you know that myne.chat is the first dApp built on top of the HOPR protocol? 🟡👀"
        ),
      0
    );
    setTimeout(
      () =>
        addReceivedMessage(
          welcome,
          "But be aware! This is only the alpha version."
        ),
      0
    );
    setTimeout(
  ...
  const loadDevHelperConversation = () => {
    ...
    // setTimeout ensures the event loop takes these state updates in order.
    setTimeout(
      () => addReceivedMessage(dev, "Welcome to the developer mode."),
      0
    );
    setTimeout(
      () =>
        addReceivedMessage(
          dev,
          "This conversation is only available during development."
        ),
      0
    );
    setTimeout(
      () =>
        addReceivedMessage(
          dev,
          "This is how a verified message looks like.",
          "VERIFIED"
        ),
      0
    );
    setTimeout(
      () =>
        addReceivedMessage(
          dev,
          "This is how an unverified message looks like.",
          "UNVERIFIED"
        ),
      0
    );
    setTimeout(
      () =>
        addReceivedMessage(
          dev,
          "This is how a failed verification message looks like.",
          "FAILED_VERIFICATION"
        ),
      0
    );
